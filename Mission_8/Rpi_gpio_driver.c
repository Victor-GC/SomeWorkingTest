/*
 * Rpi_gpio_driver.c - GPIO Linux device driver for Raspberry Pi B+
 * Author: Victor Geng <gengchao23@163.com>
 * Version: 0.1
 * License: GPL
 */
 ...
 * @lock:
 used to protect atomic code section
 */
 ...
 * "falling" Enable falling edge triggerAppendix 1
 8 (13)
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Victor Geng <gengchao23@163.com>");
MODULE_DESCRIPTION("GPIO device driver for Raspberry Pi B+);
